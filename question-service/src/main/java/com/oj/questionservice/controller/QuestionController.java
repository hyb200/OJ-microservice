package com.oj.questionservice.controller;
...
import com.oj.backendmodel.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<Page<QuestionVO>> listQuestionVOByPage(@RequestBody QuestionQueryRequest questionQueryRequest,
        ...
        String redisKey = String.format("oj:question:%d", current);
        RBucket<Page<Question>> bucket = redissonClient.getBucket(redisKey);

        Page<Question> questionPage = null;
        if (questionQueryRequest.isSearch()) {
            //  从数据库中搜索
            ...
            //  将查询结果写入缓存
            try {
                bucket.set(questionPage, Duration.ofHours(1L));
            } catch (Exception e) {
    ...
    public BaseResponse<Long> doQuestionSubmit(@RequestBody QuestionSubmitAddRequest questionSubmitAddRequest,
        ...
        //  限流判断，每个用户一个限流器
        redisLimiterManager.doRateLimit("question_submit:limit_" + loginUser.getId());
